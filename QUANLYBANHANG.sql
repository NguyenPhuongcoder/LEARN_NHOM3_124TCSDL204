...
(N'CT001',N'THIÊN LONG',N'SAIGONMART',N'ĐÀ NẴNG',N'0865658451',525525,info@saigonmart.vn),  

(N'CT002',N'THIÊN KIM',N'GIAOHANG',N'QUẢNG NAM',N'0865658452',325325,contact@viettrade.com),  

(N'CT003',N'HÒA BÌNH',N'SAIGONMART',N'ĐÀ NẴNG',N'0865658453',625625,support@bigshop.vn),  

(N'CT004',N'THIÊN LONG',N'VIETTRADE',N'HUẾ',N'0865658454',225225,sales@giaodich24h.com),  

(N'CT005',N'HÒA BÌNH',N'SAIGONMART',N'QUẢNG NAM',N'0865658455',525525,customer@vinatrade.vn),  

(N'CT006',N'THIÊN LONG',N'VIETTRADE',N'ĐÀ NẴNG',N'0865658456',125125,hello@megastore.vn),  

(N'CT007',N'HÒA BÌNH',N'MEGASTORE',N'QUẢNG NAM',N'0865658457',525525,service@vietmart.com),  

(N'CT008',N'KIM PHÁT ',N'SAIGONMART',N'HUẾ',N'0865658458',325325,admin@thanhcongtrade.vn),  

(N'CT009',N'THIÊN LONG',N'MEGASTORE',N'HUẾ',N'0865658459',525525,support@sieuthiso.vn),  

(N'CT0010',N'KIM PHÁT',N'SIEUTHISO',N'QUẢNG TRỊ',N'0865658410',925925,info@daisymart.com); 
...
('HD002','MH002',2500,200,5), 

('HD003','MH003',3500,1000,8), 

('HD004','MH004',4500,150,5), 

('HD005','MH005',5500,100,10), 

('HD006','MH006',6500,300,5), 

('HD007','MH007',7500,100,4), 

('HD008','MH008',7500,600,5), 

('HD009','MH009',8500,100,3), 

('HD010','MH010',9500,500,5); 
------------------------------------------------------------------UPDATE----------------------------------------------------------------------------
--Hữu Sáng
...
UPDATE MATHANG 
SET SOLUUONG = SOLUONG * 2  
FROM  DONDATHANG d, NHACUNGCAP c
WHERE d.MACONGTY=D.MACONGTY AND NHACUNGCAP = N’THIÊN LONG’; 
